    ...
    return new PaymentMethodEntity(
      {
        ...
        brand: raw.brand ? CardBrand.create(raw.brand) : null,
        last4: raw.last4 ? new Last4(raw.last4) : null,
        expMonth: raw.expMonth ? new ExpMonth(raw.expMonth) : null,
        expYear: raw.expYear ? new ExpYear(raw.expYear) : null,
